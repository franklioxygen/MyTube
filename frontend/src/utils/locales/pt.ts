export const pt = {
  ...
  confirmDownloadAllPlaylists: "Baixar todas as playlists deste canal? Isso criará uma coleção para cada playlist.",
  ...
  tmdbApiKeyHelper: "Chave API do TheMovieDB para buscar metadados e pôsteres de filmes/séries. Obtenha sua chave em https://www.themoviedb.org/settings/api",
  mountDirectories: "Diretórios de montagem",
  mountDirectoriesPlaceholder: "Digite os diretórios de montagem (um por linha)\nExemplo:\n/mnt/media1\n/mnt/media2",
  mountDirectoriesHelper: "Digite os diretórios de montagem onde os arquivos de vídeo estão armazenados, um diretório por linha",
  mountDirectoriesEmptyError: "Por favor, digite pelo menos um diretório de montagem",
  ...
  scanMountDirectoriesSuccess: "Verificação de diretórios montados concluída. {addedCount} novos vídeos adicionados. {deletedCount} vídeos ausentes removidos.",
  subscribePlaylistsSuccess: "Inscrito com sucesso em {count} lista{plural} de reprodução.",
  subscribePlaylistsSkipped: "{count} lista{plural} de reprodução {wasWere} já inscrita{plural}.",
  ...
  formatLegacyFilenamesDescription: "Renomear em lote todos os arquivos de vídeo, miniaturas e legendas para o novo formato padrão: Título-Autor-AAAA. Esta operação modificará os nomes dos arquivos no disco e atualizará a lógica do banco de dados.",
  ...
  formatFilenamesSuccess: "Processado: {processed}\nRenomeado: {renamed}\nErros: {errors}",
  ...
  visitorPasswordSetHelper: "A senha está definida. Deixe em branco para mantê-la.",
  ...
  cloudDriveDescription: "Faça upload automático de vídeos para o armazenamento em nuvem (Alist) e verifique se há novos arquivos na nuvem. Os arquivos locais serão excluídos após o upload bem-sucedido.",
  ...
  cloudDriveNote: "Após habilitar este recurso, os vídeos recém-baixados serão automaticamente enviados para o armazenamento em nuvem e os arquivos locais serão excluídos. Os vídeos serão reproduzidos do armazenamento em nuvem via proxy.",
  ...
  passkeyCreationFailed: "Falha ao criar chave de acesso. Por favor, tente novamente.",
  ...
  removePasskeysMessage: "Tem certeza de que deseja remover todas as chaves de acesso? Esta ação não pode ser desfeita.",
  passkeysRemoved: "Todas as chaves de acesso foram removidas",
  passkeysRemoveFailed: "Falha ao remover chaves de acesso. Por favor, tente novamente.",
  loginWithPasskey: "Entrar com chave de acesso",
  authenticating: "Autenticando...",
  passkeyLoginFailed: "Falha na autenticação com chave de acesso. Por favor, tente novamente.",
  ...
  createCollectionFromAuthorTooltip: "Mover todos os vídeos deste autor para uma coleção",
  creatingCollection: "Criando coleção...",
  collectionCreatedFromAuthor: "Coleção criada e todos os vídeos movidos com sucesso",
  ...
  createCollectionFromAuthorConfirmation: "Uma coleção chamada \"{author}\" será criada e todos os vídeos deste autor serão movidos para ela. Continuar?",
  createCollectionFromAuthorConfirmationWithMove: "Uma coleção chamada \"{author}\" será criada e todos os vídeos deste autor serão movidos para ela. {count} vídeo(s) que estão atualmente em outras coleções serão movidos para esta nova coleção. Continuar?",
  addVideosToCollection: "Adicionar Vídeos à Coleção",
  addVideosToExistingCollectionConfirmation: "Adicionar {count} vídeo(s) do autor \"{author}\" à coleção existente \"{author}\". Continuar?",
  addVideosToExistingCollectionConfirmationWithMove: "Adicionar {count} vídeo(s) do autor \"{author}\" à coleção existente \"{author}\". {moveCount} vídeo(s) que estão atualmente em outras coleções serão movidos para esta coleção. Continuar?",
  ...
  subscribeChannelChoiceDescription: "Escolha se inscrever em todos os vídeos ou em todas as listas de reprodução deste canal. Inscrever-se em todas as listas de reprodução também o inscreverá nas futuras listas de reprodução criadas pelo autor.",
  subscribeAllVideos: "Inscrever-se em todos os vídeos",
  subscribeAllPlaylists: "Inscrever-se em todas as listas de reprodução",
  subscribeAllPlaylistsDescription: "Isso se inscreverá em todas as playlists deste canal.",
  ...
  ytDlpConfigurationDescription: "Configure as opções de download do yt-dlp. Veja",
  ...
  allowedHostsHelper: "Lista de hosts permitidos para o servidor de desenvolvimento Vite (separados por vírgulas). Lista de permissões de domínio para Cloudflare Tunnel.",
  allowedHostsRequired: "As Rotas de Aplicação Publicadas são obrigatórias quando um token de túnel é fornecido.",
  ...
  exportImportDatabaseDescription: "Exporte seu banco de dados como arquivo de backup ou importe um backup previamente exportado. A importação substituirá os dados existentes pelos dados de backup.",
  ...
  importDatabaseWarning: "Aviso: Importar um banco de dados substituirá todos os dados existentes. Certifique-se de exportar primeiro seu banco de dados atual como backup.",
  ...
  restoreFromLastBackupWarning: "Aviso: Isso restaurará o banco de dados do último arquivo de backup automático. Todos os dados atuais serão substituídos pelos dados de backup. Esta ação não pode ser desfeita. Tem certeza de que deseja continuar?",
  restoreFromLastBackupSuccess: "Banco de dados restaurado com sucesso do backup",
  ...
  sensitiveContentWarning: "Este vídeo pode conter conteúdo sensível. Clique para ver.",
  ...
  saveAuthorFilesToCollectionDescription: "Salvar automaticamente os arquivos do autor em uma coleção separada.",
  soundNone: "Nenhum",
  soundBell: "Sino",
