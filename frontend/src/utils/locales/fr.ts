export const fr = {
  ...
  confirmDownloadAllPlaylists: "Télécharger toutes les listes de lecture de cette chaîne ? Cela créera une collection pour chaque liste de lecture.",
  ...
  mountDirectoriesPlaceholder: "Entrez les répertoires de montage (un par ligne)\nExemple :\n/mnt/media1\n/mnt/media2",
  mountDirectoriesHelper: "Entrez les répertoires de montage où sont stockés les fichiers vidéo, un répertoire par ligne",
  mountDirectoriesEmptyError: "Veuillez entrer au moins un répertoire de montage",
  ...
  scanMountDirectoriesSuccess: "Analyse des répertoires de montage terminée. {addedCount} nouvelles vidéos ajoutées. {deletedCount} vidéos manquantes supprimées.",
  subscribePlaylistsSuccess: "Abonnement réussi à {count} liste{plural} de lecture.",
  subscribePlaylistsSkipped: "{count} liste{plural} de lecture {wasWere} déjà abonnée{plural}.",
  ...
  formatLegacyFilenamesDescription: "Renommer par lot tous les fichiers vidéo, miniatures et sous-titres au nouveau format standard : Titre-Auteur-AAAA. Cette opération modifiera les noms de fichiers sur le disque et mettra à jour la logique de la base de données.",
  ...
  formatFilenamesSuccess: "Traités : {processed}\nRenommés : {renamed}\nErreurs : {errors}",
  ...
  visitorUserHelper: "Activez un compte visiteur séparé avec un accès en lecture seule. Les visiteurs peuvent voir le contenu mais ne peuvent pas effectuer de modifications.",
  visitorPassword: "Mot de passe Visiteur",
  visitorPasswordHelper: "Définissez le mot de passe pour le compte visiteur.",
  visitorPasswordSetHelper: "Le mot de passe est défini. Laisser vide pour le conserver.",
  ...
  cloudDriveDescription: "Télécharge automatiquement les vidéos sur le stockage cloud (Alist) et recherche les nouveaux fichiers dans le cloud. Les fichiers locaux seront supprimés après un téléchargement réussi.",
  ...
  cloudDriveNote: "Après avoir activé cette fonctionnalité, les vidéos nouvellement téléchargées seront automatiquement téléchargées vers le stockage cloud et les fichiers locaux seront supprimés. Les vidéos seront lues depuis le stockage cloud via un proxy.",
  ...
  passkeyCreationFailed: "Échec de la création de la clé d'accès. Veuillez réessayer.",
  ...
  removePasskeysMessage: "Êtes-vous sûr de vouloir supprimer toutes les clés d'accès ? Cette action ne peut pas être annulée.",
  passkeysRemoved: "Toutes les clés d'accès ont été supprimées",
  passkeysRemoveFailed: "Échec de la suppression des clés d'accès. Veuillez réessayer.",
  loginWithPasskey: "Se connecter avec une clé d'accès",
  authenticating: "Authentification en cours...",
  passkeyLoginFailed: "Échec de l'authentification par clé d'accès. Veuillez réessayer.",
  ...
  createCollectionFromAuthorTooltip: "Déplacer toutes les vidéos de cet auteur vers une collection",
  creatingCollection: "Création de la collection...",
  collectionCreatedFromAuthor: "Collection créée et toutes les vidéos déplacées avec succès",
  failedToCreateCollectionFromAuthor: "Échec de la création de la collection de l'auteur",
  collectionAlreadyExists: "Une collection portant ce nom existe déjà",
  createCollectionFromAuthorConfirmation: "Une collection nommée \"{author}\" sera créée et toutes les vidéos de cet auteur y seront déplacées. Continuer ?",
  createCollectionFromAuthorConfirmationWithMove: "Une collection nommée \"{author}\" sera créée et toutes les vidéos de cet auteur y seront déplacées. {count} vidéo(s) actuellement dans d'autres collections seront déplacées vers cette nouvelle collection. Continuer ?",
  addVideosToCollection: "Ajouter des vidéos à la collection",
  addVideosToExistingCollectionConfirmation: "Ajouter {count} vidéo(s) de l'auteur \"{author}\" à la collection existante \"{author}\". Continuer ?",
  addVideosToExistingCollectionConfirmationWithMove: "Ajouter {count} vidéo(s) de l'auteur \"{author}\" à la collection existante \"{author}\". {moveCount} vidéo(s) actuellement dans d'autres collections seront déplacées vers cette collection. Continuer ?",
  ...
  subscribeChannelChoiceMessage: "Comment souhaitez-vous vous abonner à cette chaîne ?",
  subscribeChannelChoiceDescription: "Choisissez de vous abonner à toutes les vidéos ou à toutes les listes de lecture de cette chaîne. S'abonner à toutes les listes de lecture vous abonnera également aux futures listes de lecture créées par l'auteur.",
  subscribeAllVideos: "S'abonner à toutes les vidéos",
  subscribeAllPlaylists: "S'abonner à toutes les listes de lecture",
  subscribeAllPlaylistsDescription: "Cela vous abonnera à toutes les playlists de cette chaîne.",
  ...
  downloadAllPreviousWarning: "Avertissement : Cela téléchargera toutes les vidéos précédentes de cet auteur. Cela peut consommer un espace de stockage important et pourrait déclencher des mécanismes de détection de bots qui peuvent entraîner des interdictions temporaires ou permanentes de la plateforme. Utilisez à vos propres risques.",
  downloadAllPreviousVideosInPlaylists: "Télécharger les vidéos précédentes dans les playlists",
  downloadAllPlaylistsWarning: "Avertissement : Cela téléchargera toutes les vidéos de toutes les playlists de cette chaîne. Cela peut représenter un grand nombre de vidéos et consommer un espace de stockage important.",
  ...
  subscribePlaylistDescription: "Vérifier automatiquement les nouvelles vidéos ajoutées à cette playlist",
  ...
  videoWasDeleted: "Cette vidéo a été précédemment téléchargée mais a été supprimée.",
  ...
  ytDlpConfigurationDescription: "Configurez les options de téléchargement yt-dlp. Voir",
  ...
  allowedHostsHelper: "Liste d'hôtes autorisés pour le serveur de développement Vite (séparés par des virgules). Liste blanche de domaines pour Cloudflare Tunnel.",
  allowedHostsRequired: "Les Routes d'Application Publiées sont requises lorsqu'un jeton de tunnel est fourni.",
  ...
  exportImportDatabaseDescription: "Exportez votre base de données en tant que fichier de sauvegarde ou importez une sauvegarde précédemment exportée. L'importation remplacera les données existantes par les données de sauvegarde.",
  ...
  importDatabaseWarning: "Avertissement : L'importation d'une base de données remplacera toutes les données existantes. Assurez-vous d'abord d'exporter votre base de données actuelle en tant que sauvegarde.",
  ...
  restoreFromLastBackupWarning: "Avertissement : Cela restaurera la base de données depuis le dernier fichier de sauvegarde automatique. Toutes les données actuelles seront remplacées par les données de sauvegarde. Cette action ne peut pas être annulée. Êtes-vous sûr de vouloir continuer ?",
  restoreFromLastBackupSuccess: "Base de données restaurée avec succès depuis la sauvegarde",
  ...
  failedToUpdateCollection: "Échec de la mise à jour de la collection, utilisez un nom différent",
  collectionNameRequired: "Le nom de la collection est requis",
  collectionNameTooLong: "Le nom de la collection doit comporter 200 caractères ou moins",
