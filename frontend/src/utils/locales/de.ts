export const de = {
 ...
 pasteUrl: "Video- oder Sammlungs-URL einfügen", download: "Herunterladen",
    ...
    noVideosYet: "Noch keine Videos. Reichen Sie eine Video-URL ein, um Ihr erstes herunterzuladen!", views: "Aufrufe",
    ...
    formatLegacyFilenamesDescription: "Batch rename all video files, thumbnails, and subtitles to the new standard format: Title-Author-YYYY. This operation will modify filenames on the disk and update the database logic.",
    ...
    source: "Quelle:", addedDate: "Hinzugefügt am:", latestComments: "Neueste Kommentare", hideComments: 'Kommentare ausblenden',
    showComments: 'Kommentare anzeigen', noComments: "Keine Kommentare verfügbar.", upNext: "Als Nächstes", noOtherVideos: "Keine anderen Videos verfügbar",
