export const zh = {
  ...
  seekControlsDescription:
    "设置短、中、长三个跳转按钮的时长。左右方向键使用短跳转时长。",
  seekShortInterval: "短跳转",
  seekMediumInterval: "中跳转",
  seekLongInterval: "长跳转",
  seekDurationUnit: "单位",
  seekUnitSeconds: "秒",
  seekUnitMinutes: "分钟",
  seekUnitHours: "小时",
  seekIntervalRangeError: "请输入 1 秒到 1 小时之间的整数时长。",
  seekIntervalOrderError: "短跳转必须小于中跳转，中跳转必须小于长跳转。",
  resetSeekIntervals: "重置跳转时长",
  seekBackwardBy: "后退 {duration}",
  seekForwardBy: "前进 {duration}",
  seekDurationSecond: "{count} 秒",
  seekDurationSeconds: "{count} 秒",
  seekDurationMinute: "{count} 分钟",
  seekDurationMinutes: "{count} 分钟",
  seekDurationHour: "{count} 小时",
  seekDurationHours: "{count} 小时",
  tagsManagement: "标签管理",
  newTag: "新标签",
  selectTags: "选择标签",
  tags: "标签",
