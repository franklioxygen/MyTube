export const zh = {
  ...
  filenameBatchRenameDescription: "将所有本地视频、图片和字幕文件重命名以匹配当前保存的命名模式。在任何预设下都可以安全运行,包括 Legacy。重命名期间下载将暂停。",
  ...
  filenameBatchRenameConfirmBody: "此操作将把所有本地视频、缩略图和字幕文件重命名为新的命名模式。操作无法自动撤销。如果中断，已重命名的文件将保留新名称。",
