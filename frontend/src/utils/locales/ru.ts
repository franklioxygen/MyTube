export const ru = {
  ...
  subscribeAllPlaylistsDescription: "Это подпишет вас на все плейлисты на этом канале.",
  ...
  downloadAllPlaylistsWarning: "Предупреждение: Это скачает все видео из всех плейлистов на этом канале. Это может быть большое количество видео и потребовать значительного объема хранилища.",
