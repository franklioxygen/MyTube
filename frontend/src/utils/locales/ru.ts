export const ru = {
  ...
  autoDeleteDescription:
    "Автоматически удаляет загруженные видео после того, как они пробыли в вашей библиотеке заданное число дней. По умолчанию отключено. Заблокируйте отдельные видео, чтобы защитить их.",
  autoDeleteInterval: "Удалять через",
  autoDeleteIntervalHelp: "Видео старше этого срока удаляются безвозвратно.",
  autoDeleteIntervalError: "Введите целое число дней (1–3650).",
  autoDeleteHowItWorks: "Как работает автоудаление",
  autoDeleteHowItWorksScan:
    "Каждый день в 03:00 (по времени сервера) MyTube сканирует вашу библиотеку.",
  autoDeleteHowItWorksDelete:
    "Любое видео, добавленное в вашу библиотеку раньше, чем указанный выше интервал, удаляется безвозвратно — его файл, миниатюра и субтитры удаляются, а история и отслеживание загрузок помечаются как удалённые, точно так же, как при ручном удалении. («Добавлено» — это когда оно попало в MyTube, а не исходная дата загрузки видео.)",
  autoDeleteHowItWorksLock:
    "Заблокированное вами видео (кнопка блокировки в плеере и на карточках видео) никогда не удаляется автоматически никаким правилом, независимо от возраста. Новые загрузки изначально разблокированы.",
  autoDeleteHowItWorksDisable:
    "Отключение немедленно останавливает эту общебиблиотечную политику автоудаления, включая активное сканирование при следующей проверке безопасности по каждому видео. Отдельная политика хранения подписки по-прежнему может удалять разблокированные видео; заблокируйте видео, чтобы защитить его от любого автоматического правила.",
  autoDeleteHowItWorksDowntime:
    "Если сервер был выключен в 03:00, сканирование запустится вскоре после следующего запуска.",
  lockVideo: "Заблокировать (защитить от автоудаления)",
  unlockVideo: "Разблокировать (разрешить автоудаление)",
  videoLocked: "Видео заблокировано — защищено от автоудаления",
  videoUnlocked: "Видео разблокировано",
  manage: "Управление",
  settings: "Настройки",
  logout: "Выйти",
  ...
  downloadsFiles: "Загрузки и файлы",
  libraryStorage: "Библиотека и хранилище",
  securityAccess: "Безопасность и доступ",
  integrationsAdvanced: "Интеграции и дополнительно",
  fileOrganization: "Организация файлов",
  language: "Язык",
  ...
  allowPasswordLoginHttpsOnlyHelper:
    "Чтобы отключить вход по паролю, откройте эту страницу по HTTPS или на localhost. Вход только по ключу доступа требует безопасного источника.",
  ...
  liveTranslationClearApiKey: "Очистить ключ",
  liveTranslationModel: "Модель живого перевода",
  liveTranslationSourceLanguage: "Исходный язык",
  liveTranslationTargetLanguage: "Целевой язык",
  liveTranslationSourceAuto: "Автоопределение",
  liveTranslationTargetRequired: "Требуется целевой язык.",
  liveTranslationSettingsSaved: "Настройки живого перевода сохранены.",
  liveTranslationDocumentation: "Документация Gemini Live Translation",
  liveTranslate: "Живой перевод",
  stopLiveTranslation: "Остановить живой перевод",
  liveTranslationConnecting: "Подключение…",
  liveTranslationTranslatingTo: "Перевод на {language}",
  liveTranslationPaused: "Приостановлено",
  ...
  liveTranslationErrorGeneric: "Ошибка живого перевода. Попробуйте ещё раз.",
  liveTranslationErrorRequiresNormalSpeed: "Для живого перевода требуется скорость воспроизведения 1x.",
  ...
  defaultVideoCodecDefault: "Авто (по умолчанию MyTube)",
  defaultVideoCodec_h264: "Лучшая совместимость (H.264 / MP4)",
  defaultVideoCodec_h265: "Расширенный: H.265 (HEVC / MP4)",
  defaultVideoCodec_av1: "Расширенный: AV1 (MP4)",
  defaultVideoCodec_vp9: "Лучшее качество (VP9 / WebM)",
  preferredVideoContainer: "Итоговый контейнер",
  preferredVideoContainerDescription:
    "Выберите контейнер для сохранённого файла после объединения потоков yt-dlp. Авто сохраняет поведение предустановки и является самым безопасным. MP4/WebM должны соответствовать выбранной предустановке кодека; MKV лучше подходит для смешанных кодеков и медиасерверов, но может не воспроизводиться напрямую в браузерах. Пользовательский yt-dlp merge-output-format переопределяет эту настройку.",
  preferredVideoContainer_auto: "Авто (следовать предустановке)",
  ...
  seekControls: "Управление перемоткой",
  seekControlsDescription:
    "Настройте короткий, средний и длинный шаг перемотки. Клавиши со стрелками используют короткий интервал.",
  seekShortInterval: "Короткий интервал",
  seekMediumInterval: "Средний интервал",
  seekLongInterval: "Длинный интервал",
  seekDurationUnit: "Единица",
  seekUnitSeconds: "секунды",
  seekUnitMinutes: "минуты",
  seekUnitHours: "часы",
  seekIntervalRangeError:
    "Введите целую длительность от 1 секунды до 1 часа.",
  seekIntervalOrderError:
    "Короткий интервал должен быть меньше среднего, а средний — меньше длинного.",
  resetSeekIntervals: "Сбросить интервалы перемотки",
  seekBackwardBy: "Перемотать назад на {duration}",
  seekForwardBy: "Перемотать вперёд на {duration}",
  seekDurationSecond: "{count} секунда",
  seekDurationSeconds: "{count} секунд",
  seekDurationMinute: "{count} минута",
  seekDurationMinutes: "{count} минут",
  seekDurationHour: "{count} час",
  seekDurationHours: "{count} часов",
  ...
  visitorAccounts: "Учётные записи посетителей",
  addVisitorUser: "Добавить посетителя",
  editVisitorUser: "Изменить посетителя",
  username: "Имя пользователя",
  userStatus: "Статус",
  userEnabled: "Включён",
  userDisabled: "Отключён",
  userLastLogin: "Последний вход",
  userNeverLoggedIn: "Никогда",
  ...
  userCreated: "Пользователь-посетитель создан",
  userUpdated: "Пользователь-посетитель обновлён",
  userDeleted: "Пользователь-посетитель удалён",
  userDeleteConfirm: "Учётная запись будет удалена, и пользователь немедленно выйдет из системы. Это действие необратимо.",
  userDisableConfirm: "Отключение завершит все сеансы этого пользователя. Позже его можно включить снова.",
  userPasswordChangeWarning: "Смена пароля завершит все сеансы этого пользователя.",
  userUsernameInvalid: "Имя пользователя должно содержать 3-32 символа: буквы, цифры, точки, дефисы или подчёркивания.",
  userUsernameReserved: "Это имя пользователя зарезервировано.",
  userUsernameTaken: "Имя пользователя уже занято.",
  userPasswordInvalid: "Пароль должен содержать от 6 до 128 символов.",
  userEnabledInvalid: "Недопустимое значение включения.",
  userNotFound: "Пользователь не найден.",
  userEmptyPatch: "Нечего обновлять.",
  noVisitorUsers: "Учётных записей посетителей пока нет.",
  legacySharedUserTooltip: "Перенесено из общего пароля посетителя",
  visitorUsersImmediateHint: "Изменения учётных записей применяются сразу и не требуют сохранения настроек.",
  visitorLoginHint: 'Если вы использовали старый общий пароль, ваше имя пользователя — "visitor".',
  ...
  noSourceUrlAvailable: "URL источника недоступен",
  downloadAlreadyInProgress: "Загрузка уже выполняется",
  ...
  mergeDatabaseStatisticsNotice:
    "Статистика, собранная этим экземпляром, остается локальной и не объединяется из загруженной базы данных.",
  ...
  mediaIntegrityAuditActionRefreshDuration:
    "Рекомендуется: обновить сохранённую длительность. Сам файл выглядит целым.",
  mediaIntegrityAuditActionManualReview:
    "Рекомендуется: проверить этот файл вручную.",
  ...
  safariVideoFormatNotSupported:
    "Формат видео не поддерживается Safari. Safari лучше всего работает с видео H.264/MP4. Пожалуйста, заново загрузите видео с кодеком H.264 или попробуйте другой браузер, например Chrome.",
  ...
  // Filename template
  filenameTemplate: "Именование файлов",
  ...
  filenamePreviewTitle: "Предпросмотр",
  ...
  filenameBatchRenameButton:
    "Переименовать существующие файлы по текущему шаблону",
  filenameBatchRenameDescription:
    "Переименовывает все локальные видео, изображения и файлы субтитров в соответствии с текущим шаблоном именования, показанным выше. Сохранение меняет только значение по умолчанию для будущих загрузок. Во время переименования загрузки приостанавливаются.",
  filenameBatchRenameDisabledRunning:
    "Задача переименования уже выполняется.",
  filenameBatchRenameDisabledInvalidTemplate:
    "Исправьте пользовательский шаблон перед запуском переименования.",
  filenameBatchRenameConfirmTitle: "Переименовать все локальные файлы?",
  filenameBatchRenameConfirmBody:
    "Это переименует все локальные видео, миниатюры и файлы субтитров в соответствии с текущим шаблоном именования, показанным выше, даже если вы еще не сохранили настройки. Операцию нельзя автоматически отменить. Если она будет прервана, уже переименованные файлы сохранят свои новые имена.",
  filenameBatchRenameConfirm: "Начать переименование",
  filenameBatchRenameRunning: "Переименование файлов…",
  filenameBatchRenamePaused:
    "Загрузки приостановлены, пока выполняется переименование.",
  filenameBatchRenameComplete: "Переименование завершено",
  filenameBatchRenameSummary:
    "{succeeded} переименовано, {skipped} пропущено, {failed} с ошибкой.",
  filenameBatchRenameError: "Не удалось переименовать",
  // Filename template reference (information panel)
  filenameRefInformationTitle: 'Справка',
  filenameRefInfoLiquid:
    'Используйте синтаксис Liquid, например {{ title }}, для псевдонимов именования MyTube и однословных полей метаданных yt-dlp.',
  filenameRefInfoYtdlp:
    'Используйте синтаксис yt-dlp, например %(upload_date>%Y-%m-%d)s или %(subtitles.en.-1.ext)s, для форматированных дат, длительностей и вложенных путей к сырым метаданным.',
  filenameRefInfoExtension:
    'Последний сегмент имени файла должен заканчиваться на .{{ ext }}, .%(ext)s или .%(ext)S.',
  filenameRefInfoFallbacks:
    'source_collection_name/id может быть пустым при загрузке одного видео; media_playlist_index заменяется на 00 вне источников-плейлистов.',
  filenameRefSectionCoreTitle: 'Основные поля',
  filenameRefSectionUploadTitle: 'Пространство имён upload_*',
  filenameRefSectionSourceTitle: 'Пространство имён source_*',
  filenameRefSectionPlaylistTitle: 'Пространство имён плейлистов',
  filenameRefSectionSeasonTitle: 'Псевдонимы season_*',
  filenameRefSectionStaticTitle: 'Псевдонимы static_*',
  filenameRefSectionRawMetadataTitle: 'Сырые метаданные yt-dlp',
  ...
  filenameRefItemDurationStringDesc: 'Длительность в формате HH-MM-SS или MM-SS.',
  filenameRefItemArtistNameDesc: 'Цепочка резервных значений в стиле исполнителя для именования в медиацентре.',
  filenameRefItemUploadDateDesc: 'Дата загрузки в формате ГГГГММДД.',
  filenameRefItemUploadYyyyMmDdDesc: 'Дата загрузки в формате ГГГГ-ММ-ДД.',
  filenameRefItemUploadYearDesc: 'Год загрузки.',
  filenameRefItemUploadMonthDesc: 'Месяц загрузки.',
  filenameRefItemUploadDayDesc: 'День месяца загрузки.',
  filenameRefItemSourceCustomNameDesc:
    'Имя источника или подписки, заданное пользователем. При прямой загрузке используется имя загрузчика или канала, если пользовательское значение не задано.',
  filenameRefItemSourceCollectionNameDesc: 'Название канала, плейлиста или коллекции при наличии.',
  filenameRefItemSourceCollectionIdDesc: 'ID канала, плейлиста или коллекции при наличии.',
  filenameRefItemSourceCollectionTypeDesc: 'Одно из: channel, playlist, single или unknown.',
  filenameRefItemMediaPlaylistIndexDesc: 'Индекс плейлиста, дополненный до двух цифр.',
  filenameRefItemSeasonFromDateDesc: 'Год загрузки.',
  filenameRefItemSeasonEpisodeFromDateDesc: 'Ключ эпизода на основе даты.',
  filenameRefItemSeasonEpisodeIndexFromDateDesc: 'Ключ эпизода на основе даты с двузначным суффиксом дневного индекса.',
  filenameRefItemSeasonByYearEpisodeByDateDesc: 'Папка сезона плюс ключ эпизода на основе даты.',
  filenameRefItemSeasonByYearEpisodeByDateAndIndexDesc: 'Папка сезона плюс ключ эпизода на основе даты с суффиксом дневного индекса.',
  filenameRefItemStaticSeasonEpisodeByIndexDesc: 'Папка «Сезон 1» плюс двузначный номер эпизода по порядку плейлиста.',
  filenameRefItemStaticSeasonEpisodeByDateDesc: 'Папка «Сезон 1» плюс ключ эпизода на основе даты.',
  filenameRefItemGenericSingleWordDesc:
    'Любое однословное поле метаданных yt-dlp можно использовать с синтаксисом Liquid, если оно присутствует в сырых метаданных.',
  filenameRefItemBasicYtdlpDesc:
    'Синтаксис заполнителей yt-dlp поддерживается для полей title, id, channel, uploader, upload_date и ext.',
  filenameRefItemFormattedUploadDateDesc: 'Форматирует upload_date с использованием форматирования дат yt-dlp.',
  filenameRefItemFormattedDurationDesc: 'Форматирует длительность с использованием форматирования времени yt-dlp.',
  filenameRefItemNestedPathDesc:
    'Читает вложенные пути к сырым метаданным, включая индексы массивов, через синтаксис заполнителей yt-dlp.',

  // Statistics
  statisticsTitle: "Статистика",
  statisticsSection: "Статистика",
  statisticsHelper: "Статистика хранится только локально в MyTube.",
  statisticsEnableLabel: "Включить сбор статистики",
  statisticsRetentionLabel: "Хранить подробные данные событий",
  statisticsRetention90: "90 дней",
  statisticsRetention365: "365 дней",
  statisticsRetentionForever: "Бессрочно",
  statisticsCaptureSearchTextLabel:
    "Включать исходный текст поиска в отчёты",
  statisticsTrackVisitorLabel: "Отслеживать активность посетителей",
  statisticsKeepDataLabel: "Сохранять данные при отключении сбора",
  statisticsClear: "Очистить собранную статистику",
  statisticsClearConfirm: "Очистить все собранные статистические данные?",
  statisticsClearSuccess: "Статистические данные очищены.",
  statisticsAdminOnly: "Статистика доступна только администраторам.",
  statisticsDisabledNotice:
    "Сбор статистики отключён. Включите его в Настройки → Дополнительно → Статистика.",
  statisticsDisabledKeepVisibleNotice:
    "Сбор статистики отключён. Существующие отчёты останутся доступными, пока вы их не очистите.",
  statisticsDisabledOpenSettings: "Изменить в настройках",
  statisticsHealth: "Состояние статистики",
  statisticsLastRunAt: "Последний запуск {date}",
  statisticsWorkerNotRunYet: "Воркер еще не запускался",
  statisticsDirtyDays: "Дней с изменениями: {count}",
  statisticsSealedDays: "Запечатанных дней: {count}",
  statisticsLastHourAccepted: "Принято за последний час: {count}",
  statisticsDropped: "Отброшено: {count}",
  statisticsErrors: "Ошибки: {count}",
  statisticsSealedDayDrops: "Отброшено в запечатанных днях: {count}",
  statisticsCompletedCount: "{count} завершено",
  statisticsFailedCount: "{count} с ошибкой",
  statisticsNotEnoughHistoricalDataYet:
    "Исторических данных пока недостаточно",
  statisticsNoData: "Нет данных",
  statisticsItem: "Элемент",
  statisticsValue: "Значение",
  statisticsDaysRemaining: "{count} дн.",
  statisticsDiskRunwayUnavailable: "Недоступно для этого режима хранения",
  statisticsDiskRunwayInsufficientActivity: "Недостаточно недавней активности",
  statisticsFailureBucket_auth_required: "Требуется аутентификация",
  statisticsFailureBucket_source_unavailable: "Источник недоступен",
  statisticsFailureBucket_geo_or_network_blocked: "Гео- или сетевой блок",
  statisticsFailureBucket_extractor_changed: "Изменился экстрактор",
  statisticsFailureBucket_filesystem_error: "Ошибка файловой системы",
  statisticsFailureBucket_cloud_upload_failed: "Сбой загрузки в облако",
  statisticsFailureBucket_unknown: "Неизвестно",
  totalVideos: "Всего видео",
  totalStorage: "Общий объём хранения",
  downloadSuccessRate: "Успешность загрузок",
  netNewVideos: "Чистый прирост видео",
  downloadVolume: "Объём загрузок",
  watchTime: "Время просмотра",
  diskRunway: "Запас диска",
  activeSubscriptions: "Активные подписки",
  activeRssTokens: "Активные RSS-токены",
  watchTimeByDay: "Время просмотра по дням",
  completedVsFailedByDay: "Успешные и неудачные загрузки по дням",
  libraryAdditionsByDay: "Пополнения библиотеки по дням",
  topWatchedVideos: "Самые просматриваемые видео",
  mostProductiveSubscriptions: "Самые продуктивные подписки",
  mostAccessedRssFeeds: "Самые посещаемые RSS-ленты",
  mostCommonFailures: "Самые частые категории ошибок",
  largestNeverWatched: "Самые большие непросмотренные элементы",
  ...
  recomputeStatistics: "Пересчитать",
  favorite: "Избранное",
  ...
  favoriteCollections: "Избранные коллекции",
  favoriteAuthors: "Избранные авторы",
  ...
  favoriteUnavailable: "Недоступно",
  favoritesLoadFailed: "Не удалось загрузить некоторые избранные элементы",
  stars: "звёзд",
  play: "Воспроизвести",
  ...
  or: "ИЛИ",
  gestureLogin: "Вход жестом",
  gestureLoginHelper: "Нарисуйте узор 3x3, чтобы войти как администратор. Вход по паролю остаётся доступным для восстановления после трёх неверных жестов.",
  gestureLoginConvenienceWarning: "Жест — это удобство, а не замена пароля. По возможности используйте HTTPS.",
  gestureLoginPasswordRequired: "Сначала включите и сохраните вход по паролю.",
  gestureLoginSavePrerequisitesFirst: "Сохраните настройки входа и пароля, прежде чем включать вход жестом.",
  gestureLoginDisablePasswordBlocked: "Отключите вход жестом, прежде чем отключать вход по паролю.",
  gestureLoginSetUpTitle: "Настроить вход жестом",
  gestureLoginChange: "Изменить жест",
  gestureLoginChangeTitle: "Изменить жест",
  gestureLoginSetNew: "Задать новый жест",
  gestureLoginRemoveTitle: "Отключить вход жестом",
  gestureLoginRemoveMessage: "Сохранённый жест будет удалён немедленно. Это действие нельзя отменить.",
  gestureLoginRemoveFailed: "Не удалось удалить вход жестом. Попробуйте ещё раз.",
  gestureLoginStep: "Шаг {current} из {total}",
  gestureLoginDrawInstruction: "Нарисуйте жест, соединяющий не менее 3 точек.",
  gestureLoginConfirmInstruction: "Нарисуйте тот же жест ещё раз для подтверждения.",
  gestureLoginReleaseInstruction: "Удерживайте и рисуйте. Отпустите, чтобы подтвердить этот шаг.",
  gestureLoginSignInInstruction: "Удерживайте и рисуйте; отпустите, чтобы войти.",
  gestureLoginStepTwoAnnouncement: "Нарисуйте тот же жест ещё раз для подтверждения.",
  ...
  gestureLoginRetryStatus: "Повторить",
};
