export const ar = {
  ...
  // Filename template (English fallback)
  ...
  filenameBatchRenameDescription: "Rename all local video, image, and subtitle files to match the saved naming pattern. Safe to run in any preset, including Legacy. Downloads are paused while the rename runs.",
  ...
  filenameBatchRenameConfirmBody: "This will rename all local video, thumbnail, and subtitle files to match the new naming mode. The operation cannot be undone automatically. If interrupted, already-renamed files keep their new names.",
