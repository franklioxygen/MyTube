export const ar = {
  ...
  filenameBatchRenameButton: "Update current file names",
  filenameBatchRenameDescription: "Rename all local files to match the current naming mode. Downloads are paused during rename.",
