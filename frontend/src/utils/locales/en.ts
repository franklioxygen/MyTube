export const en = {
  ...
  fromBilibili: "From Bilibili",
  loadingBilibiliResults: "Loading Bilibili results...",
  noBilibiliResults: "No Bilibili results found",
  ...
  downloadsFiles: "Downloads & Files",
  ...
  seekControls: "Seek controls",
  seekControlsDescription:
    "Choose how far the short, medium, and long seek buttons move. The left and right arrow keys use the short interval.",
  seekShortInterval: "Short interval",
  seekMediumInterval: "Medium interval",
  seekLongInterval: "Long interval",
  seekDurationUnit: "Unit",
  seekUnitSeconds: "seconds",
  seekUnitMinutes: "minutes",
  seekUnitHours: "hours",
  seekIntervalRangeError:
    "Enter a whole duration from 1 second through 1 hour.",
  seekIntervalOrderError:
    "Short must be less than medium, and medium must be less than long.",
  resetSeekIntervals: "Reset seek intervals",
  seekBackwardBy: "Seek backward by {duration}",
  seekForwardBy: "Seek forward by {duration}",
  seekDurationSecond: "{count} second",
  seekDurationSeconds: "{count} seconds",
  seekDurationMinute: "{count} minute",
  seekDurationMinutes: "{count} minutes",
  seekDurationHour: "{count} hour",
  seekDurationHours: "{count} hours",
  ...
  showBilibiliSearch: "Show Bilibili Search Results",
  ...
  incompleteDownloadVideoGap: "Video: {seconds}s missing at {positions}",
  incompleteDownloadAudioGap: "Audio: {seconds}s missing at {positions}",
  incompleteDownloadFragments: "Fragments that could not be downloaded: {count}. Download again to try to recover them.",
  ...
  gestureLoginHelper: "Draw a 3x3 pattern to sign in as admin. Password login stays available as recovery after three incorrect gestures.",
  gestureLoginConvenienceWarning: "A gesture is a convenience, not a replacement for your password. Use HTTPS where possible.",
  gestureLoginPasswordRequired: "Enable and save password login first.",
  gestureLoginSavePrerequisitesFirst: "Save login and password settings before enabling Gesture Login.",
  gestureLoginDisablePasswordBlocked: "Turn off Gesture Login before disabling password login.",
  gestureLoginSetUpTitle: "Set Up Gesture Login",
  gestureLoginChange: "Change Gesture",
  gestureLoginChangeTitle: "Change Gesture",
  gestureLoginSetNew: "Set New Gesture",
  gestureLoginRemoveTitle: "Turn Off Gesture Login",
  gestureLoginRemoveMessage: "This deletes the saved gesture immediately. This action cannot be undone.",
  gestureLoginRemoveFailed: "Gesture Login could not be removed. Please try again.",
  gestureLoginStep: "Step {current} of {total}",
  gestureLoginDrawInstruction: "Draw a gesture connecting at least 3 dots.",
  gestureLoginConfirmInstruction: "Draw the same gesture again to confirm.",
  gestureLoginReleaseInstruction: "Press and hold to draw. Release to confirm this step.",
  gestureLoginSignInInstruction: "Press and hold to draw; release to sign in.",
  gestureLoginStepTwoAnnouncement: "Draw the same gesture again to confirm.",
