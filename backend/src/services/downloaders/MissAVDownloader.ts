  ...
  static async downloadVideo(
    ...
    try {
      ...
      if (!m3u8Url) {
        ...
        fs.writeFileSync(debugFile, html); // nosemgrep: javascript.pathtraversal.rule-non-literal-fs-filename
      ...
      if (fs.existsSync(newVideoPath)) { // nosemgrep: javascript.pathtraversal.rule-non-literal-fs-filename
        let counter = 1;
      ...
      try {
        ...
        if (fs.existsSync(newVideoPath)) {
          // nosemgrep: javascript.pathtraversal.rule-non-literal-fs-filename
          const stats = fs.statSync(newVideoPath); // nosemgrep: javascript.pathtraversal.rule-non-literal-fs-filename
      ...
      try {
        ...
        // nosemgrep: javascript.pathtraversal.rule-non-literal-fs-filename
        if (fs.existsSync(cleanupVideoPath)) await safeRemove(cleanupVideoPath); // nosemgrep: javascript.pathtraversal.rule-non-literal-fs-filename
        // nosemgrep: javascript.pathtraversal.rule-non-literal-fs-filename
        if (fs.existsSync(cleanupThumbnailPath)) // nosemgrep: javascript.pathtraversal.rule-non-literal-fs-filename
        ...
        // nosemgrep: javascript.pathtraversal.rule-non-literal-fs-filename
        if (fs.existsSync(cleanupVideoPathMp4)) // nosemgrep: javascript.pathtraversal.rule-non-literal-fs-filename
